//Create button in remote content to mark item as 'Pronto'
let readitClose = document.createElement('div')
readitClose.innerText = 'Pronto'
...
//Append buttom to body

//document.getElementsByTagName('body')[0].appendChild(readitClose) Não usar
